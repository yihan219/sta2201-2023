...
Since students can perform better or worse than their first attempt, $\theta$ should be in the range (-1,1), however, since they take 50 practice shots each day, I would tend to believe that the average improve is 25 balls. Hence an informative prior could be a Beta(1,3) which has mean=0.25.
